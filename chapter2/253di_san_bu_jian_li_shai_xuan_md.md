...
PS: 在应聘者列表-全部应聘者、待归档应聘者；职位下应聘者列表、储备库下应聘者列表都可进行自定义显示。

用鼠标直接拖动各字段，可调整列表字段显示的前后位置。
...
点击应聘者列表上方的“配置筛选条件”，可自行设置常用的搜索条件（最多9项）并进行保存，最多可以保存20个搜索条件。
...
在应聘者列表上勾选要转发资料的应聘者，点击【转发资料】，在弹出窗口中填写收件人，编辑邮件标题和邮件正文。 

![](image126.jpg)

点击【转发资料】后，将弹出以下界面，可以输入收件人的邮箱信息，并可勾选应聘者的相关信息进行转发。 

![](image128.jpg)

在邮件正文中将包括如下的应聘者列表。收件人收到此列表后，点击“应聘者详情”即可查看此应聘者的详细资料页面。
...
系统可向应聘者批量发通知，单选、多选、全选应聘者，点击更多操作中【发通知】，则可以邮件或短信方式通知应聘者。


‘发通知’功能区别于“面试安排”及“邀请测评”，建议仅在通知情况下使用。如做面试安排，或邀请测评，系统另有操作。（如邀请测评，会有测评内容的通知）
...
#### 2.5.3.3.8 为应聘者调整简历评分



单选、多选、全选应聘者，点击应聘者列表上面更多操作中的【调整简历评分】按钮，可以为应聘者进行打分。

![](image135.png)

弹出界面如下，可以输入正负分，也可以将应聘者简历恢复原始分数。

![](image138.jpg)

在应聘者列表的齿轮位置，勾选简历评分，即可在列表中进行查看。
...
单选、多选、全选应聘者，点击应聘者列表上面更多操作中的【导入成绩】按钮，可以为应聘者导入成绩。

![](image143.png)

导入成绩时，需下载对应Excel模板，将应聘者信息填入模板中，再进行上传导入。
...
单选、多选或全选应聘者，点击应聘者列表上面更多操作中【添加备注】按钮，可为应聘者输入1000字以内的备注。
![](image146.gif)
...
单选、多选或全选应聘者，将鼠标放在应聘者列表上方更多操作上，可选择导出应聘者信息数据表或文档包，将应聘者信息存在本地进行编辑查看。

数据表导出的是应聘者的姓名、性别、联系方式、毕业院校、专业等基本信息。
 
![](image151.png)
 
![](image153.png)

选择导出文档包，会弹出文档包生成提示，稍后请到系统消息处下载文档包。文档包导出的内容为和该应聘者有关的文档，包括简历、测评报告等。
 
![](image156.gif)

选择“打印简历”或者“打印全部简历”可以将应聘者的简历信息进行导出，系统会以PDF的形式进行导出保存。
...
#### 2.5.3.3.12 将应聘者推荐到其他职位



系统可将某一招聘职位下的应聘者推荐到其他职位。操作如下：

勾选要推荐的应聘者，点击“更多操作”下的【推荐到职位】按钮：

![](image161.png)

在弹出窗口中选择要推荐到的职位，点击【确定】按钮：
...
在应聘者列表中勾选要储备的应聘者。可单选、多选、全选。点击列表上方“更多操作”下的【储备到人才库】按钮。

![](image165.png)
 
在弹出窗口中选择要推荐到的人才库，点击【确定】按钮。

![](image167.png)

**注：人才库的新增与管理见本手册2.6人才库**
...
单选、多选或全选应聘者，点击应聘者列表上方“其他操作-列入黑名单”可将应聘者列入黑名单中。

![](image169.png)

输入原因，点击【确定】，即将应聘者加入黑名单。

注：“列入黑名单”意味着此应聘者再次向企业投递简历，则简历会被系统自动转入黑名单中，而不会出现在任何职位下。请慎重使用此功能。

![](image171.png)


##### 2.5.3.3.14.2 从黑名单中撤销

点击“高级搜索”，选择“黑名单”进行查看。

![](image173.png)

在“黑名单”的应聘者列表下，可以选择应聘者进行“从黑名单中撤销”“撤销并推荐到职位”“撤销并储备到”“彻底删除”的操作。
